...
* CHAIN_ID: same as used for WIP 155 (ie. 1 for mainnet, 3 for testnet)
* NULL_SENDER: 2**160 - 1
...
Under WIP 86, we can expect users to store their ether in contracts, whose code might look like the following (example in Serpent):
