...
The solution proposed in this WIP is to charge gas only for memory that is actually written to at
...
gas is still available. Typical uses of the WIP include "reserving" `2**256-1` bytes of memory for the output.
